    ...
    <div ref={ref}>
      <StyledLinksContainer
        ...
        links={[
          ...
          {
            path: "/math/calculus/derivative/geometric-derivative-interpretation",
            children: "Geometric derivative interpretation",
          },
          {
            path: "/math/calculus/derivative/derivative-as-a-function",
            children: "Derivative as a function",
          },
          {
            path: "/math/calculus/derivative/calculating-derivatives",
            children: "Calculating derivatives",
          },
        ]}
      />
      <SubRouter
        paths={{
          "/": () => {
            return (
              <div>
                ...
                <div>
                  A derivative at a point is the <b>instantaneous rate of change</b>, and can be
                  found through limits.
                </div>
                <StyledSubTitle>Example</StyledSubTitle>
                <div>
                  Let's assume we want to find the average velocity of a car between 8:00 to 10:00
                  am if we know the position in 8:00 was 50 miles and at 10:00 220 miles.
                </div>
                <div>
                  In order to calculate the average velocity, we need to take into consideration
                  that a position is a function of time.
                </div>
                <div>That means that f(8) = 50, f(10) = 220.</div>
                <div>
                  The special notation we use to denote the change in a variable is often displayed
                  through Delta({unicodes.javascript.capitalDelta}) - it stands for{" "}
                  <b>difference</b>.
                </div>
                <MathML
                ...
                />
                <div>
                  In order to get the <b>closer</b> value to the immediate velocity of a specific
                ...
                />
                <div>
                  That's why we can say that the average velocity per minute is treated as miles per
                  hour, as the numerator is in miles, the denominator is in minutes, and by
                  conversion into hours, we get the following:
                </div>
                <MathML
                ...
                <div>
                  In general when having any function f with some input variable, then we can talk
                  about the average rate of change of f of the variable with respect to the
                ...
                />
                <StyledSubTitle>
                  Instantaneous rate of change - the derivative of a point
                </StyledSubTitle>
                <div>
                  But what if the want to know the <b>exact</b> value of such at a very specific
                  point?
                </div>
                <div>
                  Similarly to how the difference of 1 minute is closer than of 2 hours, the closer
                  we get to the initial point, the closer we get to the actual value at a specific
                  point <b>without using the same exact value twice</b>, as that would just result
                  in 0 over 0.
                </div>
                <div>Sounds familiar, doesn't it? - </div>
                <div>
                  So the solution is to take a <b>limit</b> as the second point is approaching the
                  first.
                </div>
                <MathML input="lim(b→8)(f(b)-f(8))/(b-8)" isAnExpression />
                <div>
                  <b>
                    Taking the limit of a bunch of average instantaneous rates of change of any
                    function in order to get the specific instantangeous change of a certain point
                    applies to everything.
                  </b>
                </div>
                <div>
                  The instantaneous rate of change of f(x) at x = a is called the <b>derivative</b>{" "}
                  of f.
                </div>
                <div>
                ...
                <div style={{ display: "flex", gap: "3px", flexWrap: "wrap" }}>
                  ...
                  <MathML input="-5t^2" />
                  <div>
                    is the effect of gravity, because we know that objects fall in parabolic arcs.
                    Height at time t seconds =
                  </div>
                ...
                <div>
                  ...
                  <StyledLink pathname="/math/calculus/continuity">continuous</StyledLink> and from
                  that we can tell that the limit at b = 1 is equivalent to f(1), so we can just
                ...
                <div>
                  Once again,{" "}
                  <StyledLink pathname="/math/calculus/continuity">continuous</StyledLink>, so we
                  can tell what's the velocity from f(3)
                </div>
                <MathML input="lim(b→3)-5(b-1) = -5(2) = -10(m)/(s)" isAnExpression />
                <div>
                  We can tell from that, that the average velocity is lower and that the derivative
                  of f(3) is negative. Why is that? What does that mean?
                </div>
                <div>
                  Since both f(1) and f(3) are at 115m, that means that the object we threw started
                  falling down somewhere between f(1) and f(3), as it cannot just stay in place in
                  the air.
                </div>
                <div>
                  That means, that f'(1) is positive because of the object moving upwards, while
                  f'(3) is negative because of the object moving downwards - the height f is
                  increasing/decreasing.
                </div>
                <div>
                  That means that the{" "}
                  <b>
                    sign of a derivative tells us the direction in which the function is changing
                  </b>
                  .
                </div>
                ...
                <div>
                  ...
                  <StyledLink pathname="/math/calculus/continuity">continuous</StyledLink>, so lets
                  calculate f(2):
                </div>
                <MathML input="lim(b→2)-5(b-2) = -5(0) = 0(m)/(s)" isAnExpression />
                <div>What does a 0 derivative mean?</div>
                <div>
                  If a positive derivative = f increasing, negative derivative = f decreasing, then
                  when the derivative is 0, that means the object reached the top of its trajectory,
                  has stopped going up, but hasn't quite started to go down.
                </div>
                <b>
                  The derivative at a point is related to the tangent line at that point, but it is
                  not the line itself - it is the line's slope. That's a number.
                </b>
                <b>
                  The derivative overall takes in numbers and yields outputs which are numbers.
                  Therefore, it is a function. It is not necessarily a linear function, however.
                </b>
              </div>
            );
          },
          ...
          "/calculating-derivatives": <CalculatingDerivatives />,
        }}
      />
    </div>
  );
