...
export const Gibraltar = ({ size, width = size, height = size, style }: SVGIconProps) => {
  return (
    <svg
    ...
    >
      ...
      ></path>
      <path
        d="M16.968,21.034l-.968-.561-.968,.561h-.213v.368h.213l.765,.444v2.166h-1.164v.61h.408v-.272h.392v.272h.364v.135h-.364v.272h-.392v-.272h-.408v.612h1.164v.342h.405v-3.867l.765-.444h.213v-.368h-.213Zm-.32,.184l-.647,.375-.647-.375,.647-.377,.647,.377Z"
        fill="#f3da4a"
      ></path>
