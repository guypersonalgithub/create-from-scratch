...
export const Kurdistan = ({ size, width = size, height = size, style }: SVGIconProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        d="m5,4h22c2.2077,0,4,1.7923,4,4v4H1v-4c0-2.2077,1.7923-4,4-4Z"
        fill="#ed1b1e"
        stroke-width="0"
      ></path>
      <path
