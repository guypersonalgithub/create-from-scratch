...
export const Uganda = ({ size, width = size, height = size, className, style }: SVGIconProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        d="M5,24H27c2.208,0,4,1.792,4,4H1c0-2.208,1.792-4,4-4Z"
        transform="rotate(180 16 26)"
        fill="#c82a1d"
      ></path>
      <path fill="#c82a1d" d="M1 12H31V16H1z"></path>
      <path d="M1 16H31V20H1z"></path>
      <path fill="#f7de4b" d="M1 20H31V24H1z"></path>
      <path fill="#f7de4b" d="M1 8H31V12H1z"></path>
      <path
