...
export const Panama = ({ size, width = size, height = size, className, style }: SVGIconProps) => {
  return (
    ...
    >
      ...
      <path
        fill="#081d53"
        d="M8.812 6.671L7.986 9.214 5.312 9.214 7.476 10.786 6.649 13.329 8.812 11.757 10.976 13.329 10.149 10.786 12.312 9.214 9.639 9.214 8.812 6.671z"
      ></path>
      <path
        fill="#c92d25"
        d="M22.937 17.984L22.111 20.527 19.437 20.527 21.601 22.098 20.774 24.641 22.937 23.07 25.101 24.641 24.274 22.098 26.437 20.527 23.764 20.527 22.937 17.984z"
      ></path>
    </svg>
  );
};
