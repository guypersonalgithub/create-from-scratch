...
export const NewZealand = ({ size, width = size, height = size, style }: SVGIconProps) => {
  return (
    <svg
    ...
    >
      ...
      ></path>
      <path fill="#b92831" d="M16 15.667L11 12 11 13 15.091 16 16 16 16 15.667z"></path>
      <path fill="#b92831" d="M16 4L15.752 4 10.291 8.004 11.655 8.004 16 4.818 16 4z"></path>
      <path
