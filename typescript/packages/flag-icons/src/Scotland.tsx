...
export const Scotland = ({ size, width = size, height = size, className, style }: SVGIconProps) => {
  return (
    <svg
      ...
      style={style}
    >
      <rect x="1" y="4" width="30" height="24" rx="4" ry="4" fill="#065db9" stroke-width="0"></rect>
      <path
