...
export const parseEnvironmentString = ({ environmentString }: ParseEnvironmentStringArgs) => {
  const environmentVariableIdentifier = "=${";
  const isEnvironmentVariableString = environmentString.indexOf(environmentVariableIdentifier);
